...
class TestSignupDepartmentListView:
    def test_if_get_request_is_status_200(
        self, api_client, sign_up_department_list_view_url
    ):
    ...
    def test_if_returned_query_set_only_contains_dn_greater_than_0(
        self, api_client, sign_up_department_list_view_url
    ):
        """
    ...
    def test_if_returned_data_is_correct(
        self, api_client, sign_up_department_list_view_url
    ):
        ...
        assert response.data == [
            {"value": department_1.department_number, "label": department_1.name},
            {"value": department_2.department_number, "label": department_2.name},
            {"value": department_3.department_number, "label": department_3.name},
        ]


@pytest.mark.django_db
class TestSortedDepartmentListView:
    def test_if_get_request_with_authenticated_user_is_status_200(
        self, api_client, user_instance, sorted_department_list_view_url
    ):
    ...
    def test_if_get_request_with_unauthenticated_user_is_status_403(
        self, api_client, sorted_department_list_view_url
    ):
        # Make a GET request to the SignupDepartmentListView
        response = api_client.get(sorted_department_list_view_url)
    ...
    def test_if_returned_data_is_sorted_by_user_department(
        self, api_client, sorted_department_list_view_url
    ):
...
class TestDepartmentsListView:
    def test_if_get_request_with_authenticated_user_is_status_200(
        self, api_client, user_instance, departments_list_view_url
    ):
        # Authenticate the user
        api_client.force_login(user_instance)
    ...
    def test_if_get_request_with_unauthenticated_user_is_status_403(
        self, api_client, departments_list_view_url
    ):
        # Make a GET request to the SignupDepartmentListView
        response = api_client.get(departments_list_view_url)
