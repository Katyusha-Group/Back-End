...
urlpatterns = [
    ...
    path('coursegroups/<int:pk>', views.CourseGroupListView.as_view({'get': 'list'}), name='coursegroups'),
    path('teacher-coursegroups/<int:pk>', views.TeacherCourseGroupsListView.as_view({'get': 'list'}),
         name='teacher-coursegroups'),
