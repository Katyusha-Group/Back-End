    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_unit', models.FloatField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='کل واحد')),
                ('practical_unit', models.FloatField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='واحد های عملی')),
