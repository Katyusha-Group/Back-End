# Generated by Django 3.2 on 2023-04-03 09:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_tracker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.coursetracker', verbose_name='ترکر')),
            ],
            options={
